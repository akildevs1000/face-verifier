<template>
  <span>
    <video class="mt-12" ref="videoElement" autoplay style="position: relative"></video>
    <div
      style="
        width: 320px;
        background: red;
    ...
    <v-toolbar class="text-center mx-auto" style="width: 640px" dense>
        ...
        <v-col cols="4" class="mb-1 text-center">
          <v-btn v-if="isBack" class="grey white--text" @click="$emit('prev')"
            >Prev
          </v-btn>
          <v-icon large color="primary" @click="captureImage"
            >mdi-camera</v-icon
          >
        </v-col>
